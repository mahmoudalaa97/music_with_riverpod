...
import 'package:music_with_riverpod/Models/audio_track_model.dart';
...
final audioPlayerProvider = Provider.autoDispose<AssetsAudioPlayer>((ref) {
  ...
  audioPlayer.open(
      Playlist(
          audios: playlist
              .map((audioTrackModel) => Audio.network(audioTrackModel.audioUrl, metas: Metas(
            title:  "Country",
            artist: "Florent Champigny",
            album: "CountryAlbum",
            image: MetasImage.network("${audioTrackModel.thumbnail}"), //can be MetasImage.network
          ),))
              .toList()),
